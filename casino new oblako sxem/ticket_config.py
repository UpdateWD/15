...
bot = telebot.TeleBot('1594444927:AAGRjWc0eYIWuZMT02NpWS3TXSrdxVLK6MY') # Токен бота воркеров

admin = 1353097202 # ID Админа
support = 1353097202 # ID сапорта
channel_id = -1001231831268 # ID Канала залётов
chat_worker_id = -1001261569575 # ID Чата с воркерами

bot_name = 'KProjectQBot' # Username Бота
